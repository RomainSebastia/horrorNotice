...
<main id="about">
  <section>
    ...
    <p>Sur <strong>Horror Notice</strong>, seul l'administrateur du site peut ajouter des <strong>films</strong>. Cela garantit que tous les <strong>films</strong> présents sur le site ont été choisis avec soin pour les fans de <strong>films d'horreur</strong>.</p>
